...
public abstract class ResourceUtil {
    ...
    public static URL getResourceURL(String resource) throws IOException {
        return getResourceURL(ObjectUtil.getClassLoader(), resource);
    }
    ...
    public static InputStream getResourceAsStream(String resource) throws
            IOException {
        return getResourceAsStream(ObjectUtil.getClassLoader(), resource);
    }
    ...
    public static Object instantiate(String className) throws
        ...
        return instantiate(ObjectUtil.classForName(className));
    }
